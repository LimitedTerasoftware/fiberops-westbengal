  ...
  <div class="row mb-1">
     <div class="col-md-2 mb-1">
      <div class="card stat-card">
        ...
        <div>GP Summary</div>
        <div class="badge-sub">
            <a href="<?php echo e(url('/admin/tickets?Gpstatus=DownGP')); ?>"> <i class="bi bi-caret-down-fill text-danger"></i> <span class="text-danger" id="unique-lgd">0</span>(<span class="text-danger" id="unique-lgd-percent">0</span>)</a>
            ...
            <div class="card stat-card p-1">
              <div class="row align-items-center text-center g-1" >
                <div class="col-6" style="margin-top:-13px;">
                  <a href="<?php echo e(url('/admin/tickets?category=Permanent Down&status=Onhold')); ?>">
                ...
                <div class="col-6" style="margin-bottom:-13px;">
                  <a href="<?php echo e(url('/admin/tickets?category=BSNL Scope&status=Onhold')); ?>">
      ...
      <div class="col-md-2 mb-1">
      <div class="card stat-card">
        <a href="<?php echo e(url('/admin/tickets-ongoing-intervals')); ?>">
      ...
      <div class="badge-sub">
        ...
        <div class="col-md-2 mb-1">
      <div class="card stat-card">
        <a href="<?php echo e(url('/admin/tickets-ongoing-history')); ?>">
        <div class="stat-value" id="ongoing-tickets">0</div>
        </a>
        <div>Ongoing</div>
        <div class="badge-sub">
           <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&status=OnGoing"><span class="text-success">Today : <span id="today-ongoing">0</span></span></a>  
         | <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&status=OnGoing"><span class="text-primary"> Yesterday : <span id="yesterday-ongoing">0</span></span></a>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-2 mb-1">
      <div class="card stat-card">
        <a href="<?php echo e(url('/admin/tickets?status=Onhold')); ?>"><div class="stat-value text-warning" id="r-onhold-tickets">0</div></a>
        <div>Hold</div>
        <div class="badge-sub">
              <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&status=Onhold"><span class="text-success">Today : <span id="today-onhold">0</span></span></a>  
            | <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&status=Onhold"><span class="text-primary"> Yesterday : <span id="yesterday-onhold">0</span></span></a>
      </div>
       </div>
    </div>
...
<!---
    <div class="col-md-2 mb-1">
      <div class="card stat-card">
        <a href="<?php echo e(url('/admin/tickets')); ?>"><div class="stat-value" id="total-tickets">0</div></a>
...
--->
    <div class="col-md-2 mb-1">
      <div class="card stat-card">
        <a href="<?php echo e(url('/admin/tickets-completed-history')); ?>"><div class="stat-value text-success" id="complete-ticket-percent">0%</div></a>
        <div>Completed</div>
        <div class="badge-sub">
           <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&status=Completed"><span class="text-success">Today : <span id="today-completed-tickets">0</span></span></a> 
         | <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&status=Completed"><span class="text-primary"> Yesterday : <span id="yesterday-completed-tickets">0</span></span></a>
       </div>
      </div>
    </div>
...
<div class="col-md-6 mb-2">
  <div class="card p-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-1 header-fix">
      ...
      <a href="<?php echo e(url('/admin/teams_status')); ?>" class="btn btn-sm font-weight-bold" style="background-color:#f0f6ff; color:#0d6efd; border-radius:8px; padding:4px;">More View</a>
    </div>
    ...
    <ul class="list-unstyled mb-0">
       <li class="d-flex justify-content-between py-1 header-fix">
        ...
        <a href="<?php echo e(url('/admin/dailyrepots')); ?>"><span class="font-weight-bold" id="total-teams">0</span></a>
      </li>
      ...
      <li class="d-flex justify-content-between py-1 header-fix">
        ...
        <a href="<?php echo e(url('/admin/workforce_details?stage=working&type=frt')); ?>"><span class="font-weight-bold text-primary" id="ongoing-teams">0</span></a>
      </li>
      <li class="d-flex justify-content-between py-1 header-fix">
        <span><i class="bi bi-check-square-fill text-success"></i> Completed Teams</span>
        <a href="<?php echo e(url('/admin/workforce_details?stage=completed&type=frt')); ?>"><span class="font-weight-bold text-success" id="t-completed-teams">0</span></a>
      </li>
      <li class="d-flex justify-content-between py-1 header-fix">
        <span><i class="bi bi-hourglass-split text-warning"></i> Yet to Start Teams</span>
        <a href="<?php echo e(url('/admin/workforce_details?stage=not_started&type=frt')); ?>"><span class="font-weight-bold text-warning" id="notstarted-teams">0</span></a>
      </li>
       <li class="d-flex justify-content-between py-1 header-fix">
        <span><i class="bi bi-hypnotize text-danger"></i> Tickets On Hold Teams</span>
        <a href="<?php echo e(url('/admin/workforce_details?stage=only_hold&type=frt')); ?>"><span class="font-weight-bold text-danger" id="t-hold-teams">0</span></a>
      </li>
       <li class="d-flex justify-content-between py-1 header-fix">
        <span><i class="bi bi-ban text-danger"></i> No Tickets Assigned Teams</span>
        <a href="<?php echo e(url('/admin/workforce_details?stage=no_ticket&type=frt')); ?>"><span class="font-weight-bold text-danger" id="no-t-teams">0</span></a>
      </li>
       <li class="d-flex justify-content-between py-1 header-fix">
        <span><i class="bi bi-graph-up-arrow text-danger"></i> Overloaded Teams(>2 tickets)</span>
        <a href="<?php echo e(url('/admin/workforce_details?stage=open_morethen2&type=frt')); ?>"><span class="font-weight-bold text-danger" id="more-then-2">0</span></a>
      </li>
       <li class="d-flex justify-content-between py-1 header-fix">
        <span><i class="bi bi-clock-fill text-danger"></i> Old Tickets Pending Teams</span>
        <a href="<?php echo e(url('/admin/workforce_details?stage=old_ongoing&type=frt')); ?>"><span class="font-weight-bold text-danger" id="old-tickes-teams">0</span></a>
      </li>
...
<div class="col-md-6 mb-3">
  <div class="card p-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-1 header-fix">
      ...
      <a href="<?php echo e(url('/admin/trackattendance')); ?>" class="btn btn-sm font-weight-bold " style="background-color:#e9f9f0; color:#198754; border-radius:8px; padding:4px;">View Map</a>
    </div>
  ...
  <div class="col-md-3 mb-1">
      ...
      <div class="ticket-stats mt-2">
        <div class="row text-center">
          <div class="col-md-4 text-primary">
             <a href="<?php echo e(url('/admin/tickets?category=Power&status=Onhold')); ?>">
             <div class="stat-number text-primary" id="power-hold1">0</div>
             </a>
            <small>Power</small>
          </div>
           <div class="col-md-4 text-success">
            <a href="<?php echo e(url('/admin/tickets?category=CCU/Battery&status=Onhold')); ?>">
          ...
          <div class="col-md-4 text-warning">
            <a href="<?php echo e(url('/admin/tickets?category=Fiber&status=Onhold')); ?>">
            <div class="stat-number text-warning" id="fiber-hold1">0</div>
            </a>
            <small>Fiber</small>
          </div>
          <div class="col-md-4 text-danger mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=Software/Hardware&status=Onhold')); ?>">
          ...
          <div class="col-md-4 text-danger mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=OLT&status=Onhold')); ?>">
            <div class="stat-number text-danger" id="olt-hold1">0</div>
            </a>
            <small>OLT</small>
          </div>
          <div class="col-md-4 text-success mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=Solar&status=Onhold')); ?>">
            <div class="stat-number text-success" id="solar-hold1">0</div>
            </a>
            <small>Solar</small>
          </div>
          <div class="col-md-4 text-success mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=Others&status=Onhold')); ?>">
    ...
    <!-- View Button -->
    <a href="<?php echo e(url('/admin/tickets?status=Onhold')); ?>" class="view-btn">View All</a>
  ...
  <div class="col-md-3 mb-2">
      ...
      <div class="ticket-stats mt-2">
        <div class="row text-center">
          <div class="col-md-6 text-primary">
            <a href="<?php echo e(url('/admin/tickets?category=Power&status=Open')); ?>">
            <div class="stat-number text-primary" id="power-not-started">0</div>
            </a>
            <small>Open Tickets</small>
          </div>
          <div class="col-md-6 text-warning">
            <a href="<?php echo e(url('/admin/tickets?category=Power&status=OnGoing')); ?>">
          ...
          <div class="col-md-6 text-success mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=Power&status=Completed')); ?>">
            <div class="stat-number text-success" id="power-completed">0</div>
            </a>
            <small>Completed</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&category=Power&status=Completed">
            <div class="stat-number text-success" id="power-today-completed">0</div>
            </a>
            <small>Today</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&category=Power&status=Completed">
    ...
    <!-- View Button -->
    <a href="<?php echo e(url('/admin/tickets?category=Power')); ?>" class="view-btn">View All</a>
  ...
  <i class="bi bi-router-fill text-info ticket-icon"></i>
      ...
      <div class="ticket-stats mt-2">
        <div class="row text-center">
          <div class="col-md-6 text-primary">
            <a href="<?php echo e(url('/admin/tickets?category=Fiber&status=Open')); ?>">
            <div class="stat-number text-primary" id="fiber-not-started">0</div>
            </a>
            <small>Open Tickets</small>
          </div>
          <div class="col-md-6 text-warning">
            <a href="<?php echo e(url('/admin/tickets?category=Fiber&status=OnGoing')); ?>">
          ...
          <div class="col-md-6 text-success mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=Fiber&status=Completed')); ?>">
            <div class="stat-number text-success" id="fiber-completed">0</div>
            </a>
            <small>Completed</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&category=Fiber&status=Completed">
            <div class="stat-number text-success" id="fiber-today-completed">0</div>
            </a>
            <small>Today</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&category=Fiber&status=Completed">
    ...
    <!-- View Button -->
    <a href="<?php echo e(url('/admin/tickets?category=Fiber')); ?>" class="view-btn">View All</a>
    </div>
  </div>
  ...
  <div class="col-md-3 mb-2">
    <div class="card ticket-card p-2">
      ...
      <div class="ticket-stats mt-2">
        <div class="row text-center">
          <div class="col-md-6 text-primary">
            <a href="<?php echo e(url('/admin/tickets?category=OLT&status=Open')); ?>">
            <div class="stat-number text-primary" id="olt-not-started">0</div>
            </a>
            <small>Open Tickets</small>
          </div>
          <div class="col-md-6 text-warning">
            <a href="<?php echo e(url('/admin/tickets?category=OLT&status=OnGoing')); ?>">
          ...
          <div class="col-md-6 text-success mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=OLT&status=Completed')); ?>">
          ...
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&category=OLT&status=Completed">
            <div class="stat-number text-success" id="olt-today-completed">0</div>
            </a>
            <small>Today</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&category=OLT&status=Completed">
        ...
        <!-- View Button -->
    <a href="<?php echo e(url('/admin/tickets?category=OLT')); ?>" class="view-btn">View All</a>
  ...
  <i class="bi bi-brightness-high-fill text-warning ticket-icon"></i>
      ...
      <div class="ticket-stats mt-2">
        <div class="row text-center">
          <div class="col-md-6 text-primary">
            <a href="<?php echo e(url('/admin/tickets?category=Solar&status=Open')); ?>">
            <div class="stat-number text-primary" id="solar-not-started">0</div>
            </a>
            <small>Open Tickets</small>
          </div>
          <div class="col-md-6 text-warning">
            <a href="<?php echo e(url('/admin/tickets?category=Solar&status=OnGoing')); ?>">
          ...
          <div class="col-md-6 text-success mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=Solar&status=Completed')); ?>">
            <div class="stat-number text-success" id="solar-completed">0</div>
            </a>
            <small>Completed</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&category=Solar&status=Completed">
            <div class="stat-number text-success" id="solar-today-completed">0</div>
            </a>
            <small>Today</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&category=Solar&status=Completed">
    ...
    <!-- View Button -->
    <a href="<?php echo e(url('/admin/tickets?category=Solar')); ?>" class="view-btn">View All</a>
  ...
  <i class="bi bi-motherboard-fill text-info ticket-icon"></i>
      ...
      <div class="ticket-stats mt-2">
        <div class="row text-center">
          <div class="col-md-6 text-primary">
            <a href="<?php echo e(url('/admin/tickets?category=Software/Hardware&status=Open')); ?>">
            <div class="stat-number" id="electronics-not-started">0</div>
            </a>
            <small>Open Tickets</small>
          </div>
          <div class="col-md-6 text-warning">
            <a href="<?php echo e(url('/admin/tickets?category=Software/Hardware&status=OnGoing')); ?>">
          ...
          <div class="col-md-6 text-success mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=Software/Hardware&status=Completed')); ?>">
             <div class="stat-number text-success" id="electronics-completed">0</div>
             </a>
            <small>Completed</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&category=Software/Hardware&status=Completed">
            <div class="stat-number text-success" id="electronics-today-completed">0</div>
            </a>
            <small>Today</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&category=Software/Hardware&status=Completed">
    ...
    <!-- View Button -->
    <a href="<?php echo e(url('/admin/tickets?category=Software/Hardware')); ?>" class="view-btn">View All</a>
  ...
  <i class="bi bi-battery-half text-warning ticket-icon"></i>
      ...
      <div class="ticket-stats mt-2">
        <div class="row text-center">
          <div class="col-md-6 text-primary">
            <a href="<?php echo e(url('/admin/tickets?category=CCU/Battery&status=Open')); ?>">
            <div class="stat-number text-primary" id="battery-not-started">0</div>
            </a>
            <small>Open Tickets</small>
          </div>
          <div class="col-md-6 text-warning">
            <a href="<?php echo e(url('/admin/tickets?category=CCU/Battery&status=OnGoing')); ?>">
          ...
          <div class="col-md-6 text-success mt-2">
            <a href="<?php echo e(url('/admin/tickets?category=CCU/Battery&status=Completed')); ?>">
            <div class="stat-number text-success" id="battery-completed">0</div>
            </a>
            <small>Completed</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&category=CCU/Battery&status=Completed">
            <div class="stat-number text-success" id="battery-today-completed">0</div>
            </a>
            <small>Today</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&category=CCU/Battery&status=Completed">
    ...
    <!-- View Button -->
    <a href="<?php echo e(url('/admin/tickets?category=CCU/Battery')); ?>" class="view-btn">View All</a>
  ...
  <i class="bi bi-exclamation-triangle-fill text-danger ticket-icon"></i>
      ...
      <div class="ticket-stats mt-2">
        <div class="row text-center">
          ...
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($today); ?>&to_date=<?php echo e($today); ?>&category=Others&status=Completed">
            <div class="stat-number text-success" id="other-today-completed">0</div>
            </a>
            <small>Today</small>
          </div>
          <div class="col-md-6 text-success mt-2">
            <a href="/admin/tickets?from_date=<?php echo e($yesterday); ?>&to_date=<?php echo e($yesterday); ?>&category=Others&status=Completed">
    ...
    <!-- View Button -->
    <a href="<?php echo e(url('/admin/tickets?category=Others')); ?>" class="view-btn">View All</a>
...
$(document).ready(function() {
  ...
  function loadDashboardData() {
    ...
    $.ajax({
      url: "<?php echo e(url('/admin/get_dashboard_data')); ?>",
      //url: "<?php echo e(url('/admin/dashboard-test')); ?>",
      method: "GET",
...
$(document).ready(function() {
  function loadDashboardData() {
    $.ajax({
      url: "<?php echo e(url('/admin/get_teams_data')); ?>",
      method: "GET",
      success: function(res) {
...
function loadDashboardMapData() {
    ...
    $.ajax({
        url: "<?php echo e(url('/admin/get_dashboard_map')); ?>",
        dataType: "json",
        type: "GET",
...
<!-- Google Maps -->
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(Setting::get('map_key')); ?>&callback=initDashboardMap" async defer></script> -->
<script>
