...
<body class="fixed-sidebar fixed-header content-appear skin-default">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(Setting::get('map_key')); ?>&libraries=places"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('main/assets/js/ezoom.js')); ?>"></script>
