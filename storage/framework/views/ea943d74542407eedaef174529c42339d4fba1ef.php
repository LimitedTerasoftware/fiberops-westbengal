<?php $__env->startSection('title', 'ONT Uptime Management'); ?>
                    ...
                    <div class="terrasoft-date-filters">
                        <div class="terrasoft-date-group">
                            ...
                            <input type="month" name="month" id="month"
                                 value="<?php echo e(@Request::get('month')); ?>" class="terrasoft-date-input">
                        </div>
                        <div class="terrasoft-date-group">
                            <label class="terrasoft-date-label">From Date</label>
                            <input type="date" class="terrasoft-date-input" id="from_date" name="fromDate" value="<?php echo e(@Request::get('fromDate')); ?>">
                        </div>
                        <div class="terrasoft-date-group">
                            <label class="terrasoft-date-label">To Date</label>
                            <input type="date" class="terrasoft-date-input" id="to_date" name="toDate" value="<?php echo e(@Request::get('toDate')); ?>">
                        </div>
...
<link rel="stylesheet" href="<?php echo e(asset('/css/olt.css')); ?>">
...
function closeCsvModal() {
    ...
    const routes = {
        Ontdashboard : "<?php echo e(route('admin.ont-upload')); ?>",
        Oltdashboard: "<?php echo e(route('admin.olt-upload')); ?>",
    };
