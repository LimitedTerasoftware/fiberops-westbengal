...
class CheckInController extends Controller
{
    ...
    public function createStepOne(Request $request)
    {
        ...
        $centers  = Employee::where('status', Status::ACTIVE)->where('user_id','=', $sid)->get();
        $employees = Employee::all();
        $contensts = DB::table('usedcontents')->get();
        $visitor = $request->session()->get('visitor');

        return view('admin.beenhear.edit', compact('centers','employees', 'visitor','contensts'));
    }
    ...
    {
        return view('admin.beenhear.return');
    }
    ...
    public function find_visitor(Request $request)
    {
        ...
        $visitor = Visitor::where([['is_pre_register', false], ['email', request()->email]])->orWhere([['is_pre_register', false], ['phone', request()->email]])->latest()->first();
