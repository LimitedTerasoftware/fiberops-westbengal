        ...
        <div class="pm-main-header-content clearfix">
            <div class="pm-logo float-left">
                ...
                <a href="{{route('/')}}">
                    ...
                    <div class="d-sm-none d-lg-inline-block site-name"> {{ __('Davanagere Smart City Limited  ') }}</div>
                </a>
                @endif
            </div>
            ...
            <div class="pm-main-menu-item float-right">
                ...
                <nav class="pm-main-navigation float-right clearfix ul-li">
                    <ul id="main-nav" class="navbar-nav  text-center text-capitalize clearfix">
