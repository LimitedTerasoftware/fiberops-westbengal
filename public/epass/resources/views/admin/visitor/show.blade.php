			    	...
			    	<div class="card shadow">
			    		<div class="card-body">
			    			<div class="profile-desc">
                                ...
                                <div class="single-profile">
                                    <p><b>{{ __('visitor.purpose') }}: </b> {{ $visitingDetails->used_content}}</p>
                                </div>
                                 <div class="single-profile">
                                    <p><b>{{ __('visitor.ln') }}: </b> {{ $visitingDetails->language}}</p>
                                </div>
                                <div class="single-profile">
                                    <p><b>{{ __('visitor.dob') }}: </b> {{ $visitingDetails->visitor->date_of_birth}}</p>
                                </div>
                                <div class="single-profile">
