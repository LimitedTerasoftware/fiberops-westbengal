                        ...
                        <form action="{{ route('admin.visitors.update', $visitingDetails) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label>{{ __('visitor.age') }}</label><span class="text-danger">*</span>
                                        <input type="text" name="date_of_birth" class="form-control @error('age') is-invalid @enderror datepicker" value="{{ old('age',$visitingDetails->visitor->date_of_birth) }}">
                                        @error('date_of_birth')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select id="used_content" name="used_content" class="form-control select2 @error('used_content') is-invalid @enderror">
                                        @foreach($contensts as $key => $contenst)
                                        <option value="{{ $contenst->content }}" {{ (old('used_content',$visitingDetails->used_content) == $contenst->content) ? 'selected' : '' }}>{{ $contenst->content }} </option>     
                                            @endforeach
                                        </select>
                                    ...
                                    <label for="language">{{ __('visitor.ln') }}</label><span class="text-danger">*</span>
                                        ...
                                        <option value="English" {{ (old('language',$visitingDetails->language) == 'English') ? 'selected' : '' }}>English</option>
                                        <option value="Hindi" {{ (old('language',$visitingDetails->language) == 'Hindi') ? 'selected' : '' }}>Hindi</option>
                                        <option value="Kannada" {{ (old('language',$visitingDetails->language) == 'Kannada') ? 'selected' : '' }}>Kannada</option>
                                        </select>
