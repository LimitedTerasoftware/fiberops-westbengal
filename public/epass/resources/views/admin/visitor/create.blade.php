                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input type="tel" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" pattern="[0-9]{10}">
                                        @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input type="date" name="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror " value="{{ old('date_of_birth') }}" min="1940-01-01">
                                        @error('date_of_birth')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="used_content">{{ __('visitor.purpose') }}</label><span class="text-danger">*</span>
                                        ...
                                        @foreach($contensts as $key => $contenst)
                                                <option value="{{ $contenst->content }}" {{ (old('used_content') == $contenst->content) ? 'selected' : '' }}>{{ $contenst->content }}</option>
                                            @endforeach
                                        </select>
