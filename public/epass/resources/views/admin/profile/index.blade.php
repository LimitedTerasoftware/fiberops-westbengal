                ...
                <div class="col-12 col-md-12 col-lg-5">
                    <div class="card profile-widget">
                        <div class="profile-widget-header">
                            <img alt="image" src="{{asset('images/img/'.$user->img)}}" class="rounded-circle profile-picture">
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        @endif
                                        <img class="img-thumbnail image-width mt-4 mb-3" id="previewImage" src="{{asset('images/img/'.$user->img)}}" alt="{{ $user->name }} {{ __('profile.profile_image') }}"/>
                                    </div>
                                    <div class="form-group col">
