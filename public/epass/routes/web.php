...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'installed', 'backend_permission'], 'namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::get('visitor/filter/{id}', 'VisitorController@filter')->name('visitor.filter');
    ...
    Route::get('get-visitors1', 'VisitorController@getVisitor1')->name('visitors.get-visitors1');
    Route::get('active_visitor', 'VisitorController@index1')->name('visitors.index1');
    ...
    Route::get('admin-visitor-report/{id}/{date}', 'VisitorReportController@index2')->name('admin-visitor-report.index2');
    ...
    Route::get('content_used_report', 'VisitorReportController@index1')->name('content_used_report.index');
    Route::post('content_used_report', 'VisitorReportController@index1')->name('content_used_report.post');
    ...
    //Excel Export 
    Route::get('attendance-report/export', 'AttendanceReportController@export')->name('attendance-report.export');
    ...
    Route::post('addons/create/{id}', 'EmployeeController@show1')->name('addons.create.post');
