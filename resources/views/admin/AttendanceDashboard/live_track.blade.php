...
<div class="filter-section">
    ...
    <div class="filter-actions">
         <button class="filter-btn btn-green " onclick="openTicketsModal()">
            <i class="fa fa-tag"></i>
            Tickets
        </button>
        <button class="filter-btn btn-yellow " onclick="exportLocationHistory()">
...
<div id="viewModal" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 1000; align-items: center; justify-content: center;">
    <div style="background: white; border-radius: 12px; width: 90%; max-width: 600px; max-height: 80vh; overflow-y: auto; box-shadow: 0 20px 25px rgba(0,0,0,0.15);">
        <div style="padding: 24px; border-bottom: 1px solid #e2e8f0;">
            <h2 style="margin: 0; font-size: 18px; font-weight: 600; color: #1a202c;">Tickets Details</h2>
        </div>
        <div id="tickets-list" style="padding: 24px;">
...
function displayTrackingOnMap() {
    ...
    dates.forEach((date, dayIndex) => {
        ...
        const smoothPoints = getCatmullRomPoints(formattedPoints, 20); // 20 = smoothness
        ...
        const startMarker = new google.maps.Marker({
                    ...
                    smoothPoints.forEach(p => bounds.extend(p));
                    routesLoadedCount++;
...
function getCatmullRomPoints(points, segments = 10) {
    const curvePoints = [];
    ...
    TicketsData.forEach(request => {
        ...
        ticketItem.innerHTML = `
            ...
            <div class="ticket-details">
                ...
                <div><strong>Time:</strong> ${request.created_at ? formatDateTime(request.created_at) : 'N/A'}</div>
            </div>
        `;
