...
public function OntData(Request $request)
{
    ...
    $data = $query
        ...
        ->selectRaw('SUM(CASE WHEN ont_uptime.uptime_percent >= 90 THEN 1 ELSE 0 END) as gte90_total')
        ->selectRaw('SUM(CASE WHEN ont_uptime.uptime_percent >= 50 AND ont_uptime.uptime_percent < 90 THEN 1 ELSE 0 END) as gte50_lt90')
        ->selectRaw('SUM(CASE WHEN ont_uptime.uptime_percent < 50 THEN 1 ELSE 0 END) as lt50_total')
...
public function OltData(Request $request)
{
    ...
    $data = $query
        ...
        ->selectRaw('SUM(CASE WHEN olt_uptime.uptime_percent >= 90 THEN 1 ELSE 0 END) as gte90_total')
        ->selectRaw('SUM(CASE WHEN olt_uptime.uptime_percent >= 50 AND olt_uptime.uptime_percent < 90 THEN 1 ELSE 0 END) as gte50_lt90')
        ->selectRaw('SUM(CASE WHEN olt_uptime.uptime_percent < 50 THEN 1 ELSE 0 END) as lt50_total')
...
public function GprouterData(Request $request)
{
    ...
    $data = $query
        ...
        ->selectRaw('SUM(CASE WHEN gp_router_uptime.uptime_percent >= 90 THEN 1 ELSE 0 END) as gte90_total')
        ->selectRaw('SUM(CASE WHEN gp_router_uptime.uptime_percent >= 50 AND gp_router_uptime.uptime_percent < 90 THEN 1 ELSE 0 END) as gte50_lt90')
...
public function BlockrouterData(Request $request)
{
    ...
    $data = $query
        ...
        ->selectRaw('SUM(CASE WHEN block_router_uptime.uptime_percent >= 90 THEN 1 ELSE 0 END) as gte90_total')
        ->selectRaw('SUM(CASE WHEN block_router_uptime.uptime_percent >= 50 AND block_router_uptime.uptime_percent < 90 THEN 1 ELSE 0 END) as gte50_lt90')
